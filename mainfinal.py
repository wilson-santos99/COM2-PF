...
class Chat_personal:
    def __init__(self,master):
        ...
        self.frmperfil = Frame(self.master, bg = "#0E3FCB",height=50,width=600)
        self.frmperfil.place(height=500, width=300, x=0, y=0)
            #SELECCIONAR PUERTO
        self.lblPort1 = Label(self.frmperfil, text="Puerto:", bg = "#0E3FCB", fg = "white", font='Verdana 10')
        ...
        self.cboCOM1.set("Ninguno")
                              #BAUDRATE 
        baudlist=['9600','19200','38400','57600','74880','115200','230400','250000']
        self.lblbaud = Label(self.frmperfil, text="BAUDRATE:", bg = "#0E3FCB", fg = "white", font='Verdana 10')
        ...
        self.tipcifr = Label(self.frmperfil, text="CIFRADO:", bg = "#0E3FCB", fg = "white", font='Verdana 10')
        ...
        #NICKNAME
        self.lblname = Label(self.frmperfil, textvariable = self.namemodificado, bg = "#0E3FCB", fg = "white", font='Verdana 14', anchor=W)
        self.lblname.place(height=25, width=150, x=20, y=80)

        self.btntitulo = Button(self.frmperfil, text = "Cambiar", bg = "#0E3FCB", fg = "white", font='Verdana 9', command=self.cambiar_nombre_Username)
        ...
        #self.btnConn1.place(height=23, width=80, x=100, y=110)
                       #BUTTON CONECTAR
        self.btnConn1 = Button(self.frmperfil, text="CONECTAR", width=12, command=self.conectar, bg = "#0E3FCB", fg = "white", font='Verdana 10')
        self.btnConn1.place(height=23, width=80, x=100, y=110)

        #SABER PUERTO CONECTADO
        self.lblmore = Label(self.frmperfil, text="Puerto conectado: ", bg = "#0E3FCB", fg = "white", font='Verdana 8',height=1,width=5, anchor=W)
        self.lblmore.place(height=25, width=108, x=20, y=150)
        
        self.lblcom = Label(self.frmperfil, textvariable=self.puertoconectado, bg = "#0E3FCB", fg = "white", font='Verdana 8',height=1,width=5)
        self.lblcom.place(height=25, width=50, x=120, y=150)     
        
  

        #BUTTON ABRIR FICHERO
        self.txtabrir = Button(self.frmperfil, text="ABRIR ARCHIVO DE TEXTO", width=12, command=self.AbrirFicher, bg = "#0E3FCB", fg = "white", font='Verdana 10',state='disabled')
        self.txtabrir.place(height=23, width=200, x=20, y=240)

        #LEYENDA TEXTO RECIBIDO EN CIFRADO TAL
        self.lblcifrado1= Label(self.frmperfil, text="CIFRADO RECIBIENDO: ", bg = "#0E3FCB", fg = "white", font='Verdana 8',height=1,width=5, anchor=W)
        self.lblcifrado1.place(height=25, width=200, x=20, y=270)
        
        self.lblcifrado = Label(self.frmperfil, text="NINGUNO", bg = "#0E3FCB", fg = "white", font='Verdana 8',height=1,width=5)
        self.lblcifrado.place(height=25, width=80, x=160, y=270) 



        #ESTADO DE CONEXION SERIAL   
        self.lbltitulo = Label(self.frmperfil, text = "Estado", bg = "#0E3FCB", fg = "white", font='Verdana 14', anchor=W)
        self.lbltitulo.place(height=30, width=100, x=20, y=180)
        self.lblestado = Label(self.frmperfil, textvariable=self.labelestado, bg = "#0E3FCB", fg = "white", font='Verdana 8',height=1,width=5, anchor=W)
        ...
        self.frmchat = Frame(self.master, bg = "#08789C")
        ...
        self.frmescribe = Frame(self.master,  bg = "#08789C")
        ...
        self.btnEnviar1 = Button(self.frmescribe, text="Enviar", width=12, command=self.envia_mensaje1, font='Verdana 8',  bg = "#4EBD4C",  fg = "white",state='disabled')
